...
print "About to register functions" # This will show if FF is run from a terminal window
# Register function form within demo.py as menu items
fontforge.registerMenuItem(samples.demo.selGlyphs,None,None,"Font",None,"Select Glyphs");
